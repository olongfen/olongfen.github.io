<template><div><h2 id="环境搭建" tabindex="-1"><a class="header-anchor" href="#环境搭建" aria-hidden="true">#</a> 环境搭建</h2>
<ul>
<li>
<p>linux环境搭建</p>
<ul>
<li>
<ol>
<li>到<a href="https://studygolang.com/dl" target="_blank" rel="noopener noreferrer">go语言中文网<ExternalLinkIcon/></a>下载对应的linux版本</li>
</ol>
</li>
<li>
<ol start="2">
<li>解压下载的包到/usr/local下&gt;&gt;&gt;&gt;&gt; sudo tar -xvf <code v-pre>下载的压缩包</code> -C /usr/local</li>
</ol>
</li>
<li>
<ol start="3">
<li>用vim打开.profile: <code v-pre>vim   ~/.bash_profile</code></li>
</ol>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># add</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>   <span class="token builtin class-name">source</span>    ~/.bash_profile
   go version
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p>windows环境搭建</p>
<ol>
<li>下载<a href="https://studygolang.com/dl" target="_blank" rel="noopener noreferrer">go语言中文网<ExternalLinkIcon/></a> .msi文件</li>
<li>然后直接安装即可</li>
<li>Win+r 输入cmd, go version</li>
</ol>
</li>
</ul>
<h2 id="gomod-指令" tabindex="-1"><a class="header-anchor" href="#gomod-指令" aria-hidden="true">#</a> gomod 指令</h2>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code>go mod init:初始化modules
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="go介绍" tabindex="-1"><a class="header-anchor" href="#go介绍" aria-hidden="true">#</a> go介绍</h2>
<ul>
<li>
<p>主要特征</p>
<ul>
...
<li>
<ol>
<li>var(变量) var str string</li>
</ol>
</li>
<li>
<ol start="2">
<li>const(常量) const num = 10</li>
</ol>
</li>
<li>
<ol start="3">
<li>type(声明类型) type num int</li>
</ol>
</li>
<li>
<ol start="4">
<li>func(函数声明) func helloWorld() {}</li>
</ol>
</li>
</ul>
</li>
</ul>
<h2 id="go类型" tabindex="-1"><a class="header-anchor" href="#go类型" aria-hidden="true">#</a> go类型</h2>
<ul>
<li>
<p>基本常用类型</p>
<ul>
...
<li>
<ol>
<li>append  		-- 用来追加元素到数组、slice中,返回修改后的数组、slice</li>
</ol>
</li>
<li>
<ol start="2">
...
<li>
<ol start="3">
<li>delete    		-- 从map中删除key对应的value</li>
</ol>
</li>
<li>
<ol start="4">
<li>panic    		-- 停止常规的goroutine  （panic和recover：用来做错误处理）</li>
</ol>
</li>
<li>
<ol start="5">
<li>recover 		-- 允许程序定义goroutine的panic动作</li>
</ol>
</li>
<li>
<ol start="6">
<li>imag    		-- 返回complex的实部   （complex、real imag：用于创建和操作复数）</li>
</ol>
</li>
<li>
<ol start="7">
<li>real    		-- 返回complex的虚部</li>
</ol>
</li>
<li>
<ol start="8">
<li>make    		-- 用来分配内存，返回Type本身(只能应用于slice, map, channel)</li>
</ol>
</li>
<li>
<ol start="9">
<li>new        		-- 用来分配内存，主要用来分配值类型，比如int、struct。返回指向Type的指针</li>
</ol>
</li>
<li>
<ol start="10">
<li>cap        		-- capacity是容量的意思，用于返回某个类型的最大容量（只能用于切片和 map）</li>
</ol>
</li>
<li>
<ol start="11">
<li>copy    		-- 用于复制和连接slice，返回复制的数目</li>
</ol>
</li>
<li>
<ol start="12">
<li>len        		-- 来求长度，比如string、array、slice、map、channel ，返回长度</li>
</ol>
</li>
<li>
<ol start="13">
<li>print、println 	-- 底层打印函数，在部署环境中建议使用 fmt 包</li>
</ol>
</li>
</ul>
</li>
</ul>
<h2 id="类型运用" tabindex="-1"><a class="header-anchor" href="#类型运用" aria-hidden="true">#</a> 类型运用</h2>
<ul>
<li>变量:
var 语句定义了一个变量的列表；跟函数的参数列表一样，类型在后面</li>
</ul>
...
<li>常量
常量的定义与变量类似，只不过使用 const 关键字，代表永远是只读的，不能修改</li>
</ul>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">const</span> name <span class="token operator">=</span> <span class="token string">"golang"</span> <span class="token comment">// 常量不能使用 ":=" 语法定义。</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>
<p>枚举:</p>
<p>iota，特殊常量，可以认为是一个可以被编译器修改的常量。
在每一个const关键字出现时，被重置为0，然后再下一个const出现之前，每出现一次iota，其所代表的数字会自动增加1。
关键字 iota 定义常量组中从 0 开始按行计数的自增枚举值。</p>
</li>
</ul>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> main
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="基本类型运用" tabindex="-1"><a class="header-anchor" href="#基本类型运用" aria-hidden="true">#</a> 基本类型运用</h2>
<ul>
<li>rune int32 的别名，代表一个Unicode码，用UTF-8 进行编码</li>
</ul>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token comment">/*
rune 类型使用
...
<p>会用到golang的 strconv包,具体使用方式这里不说明了,教程一大把 <br>
引用类型: 指针、slice、map、chan等 <br>
切片：切片是数组的一个引用，因此切片是引用类型。但自身是结构体，值拷贝传递，切片可以无限扩展 <br></p>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> main
<span class="token keyword">import</span> <span class="token string">"fmt"</span>
<span class="token keyword">func</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<li>容器Map: 引用类型，哈希表。一堆键值对的未排序集合</li>
</ul>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> main
<span class="token keyword">import</span> <span class="token string">"fmt"</span>
<span class="token keyword">func</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<li>
<ol start="3">
<li>线程安全，多个goroutine同时访问，不需要加锁</li>
</ol>
</li>
<li>
<ol start="4">
<li>channel是有类型的，一个整数的channel只能存放整数</li>
</ol>
</li>
</ul>
</li>
...
<div class="language-golang line-numbers-mode" data-ext="golang"><pre v-pre class="language-golang"><code>	// 首写字母大写其他包可以访问，反之其他包则不可以访问
...
<li>
<p>函数调用</p>
<div class="language-golang line-numbers-mode" data-ext="golang"><pre v-pre class="language-golang"><code>package main
...
<h2 id="方法与接口" tabindex="-1"><a class="header-anchor" href="#方法与接口" aria-hidden="true">#</a> 方法与接口</h2>
<ul>
<li>方法</li>
</ul>
<div class="language-golang line-numbers-mode" data-ext="golang"><pre v-pre class="language-golang"><code>
package main
...
<li>接口可以通过方法来实现，任意一个结构体都可以实现接口里面的方法,但是必须声明全部方法,不然会报错。</li>
</ul>
...
<p>直接开干</p>
<ul>
<li><code v-pre>简单的测试加减乘除&gt;&gt;&gt;main.go</code></li>
</ul>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code><span class="token keyword">package</span> demo
...
<li>
<p><code v-pre>main_test.go</code></p>
</li>
</ul>
<div class="language-go line-numbers-mode" data-ext="go"><pre v-pre class="language-go"><code>  <span class="token keyword">package</span> demo
  ...
  <span class="token keyword">func</span> <span class="token function">TestDiv</span><span class="token punctuation">(</span>t <span class="token operator">*</span>testing<span class="token punctuation">.</span>T<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span><span class="token punctuation">)</span>
  <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>执行：go test . </code></p>
</div></template>
